        ...
        <div class="container-fluid">
          ...
          <nav>
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="./views/login/login.php">Iniciar Sesión 1</a>
                </li>
...
<div id="carouselExampleCaptions" class="carousel slide  bg-light text-dark" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./resources/img/cal.png" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="./resources/img/chec.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="./resources/img/com.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
